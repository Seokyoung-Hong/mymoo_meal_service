...
def upgrade() -> None:
    ...
    op.create_index(
        "restaurant_submission_name_index",
        "Restaurant_submission",
        ["name"],
        unique=False,
    )
    op.create_index(
        "restaurant_submission_status_index",
        "Restaurant_submission",
        ["status"],
        unique=False,
    )
    op.create_index(
        "restaurant_submission_submitter_index",
        "Restaurant_submission",
        ["submitter"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "(restaurant_id IS NOT NULL AND submission_id IS NULL) OR (restaurant_id IS NULL AND submission_id IS NOT NULL)",
        ...
        sa.ForeignKeyConstraint(
            ["submission_id"], ["Restaurant_submission.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "restaurant_submission_submitter_index", table_name="Restaurant_submission"
    )
    op.drop_index(
        "restaurant_submission_status_index", table_name="Restaurant_submission"
    )
    op.drop_index(
        "restaurant_submission_name_index", table_name="Restaurant_submission"
    )
